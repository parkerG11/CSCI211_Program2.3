...
public class Github implements GithubADT{
	...
	public void insert(int pos, String add) {
		...
		//master.add(0, "System.out.println");
		//master.add(18, "(“Hello World”);");
		code = "System.out.println";
		branch.push(new Undo(code, 0, code.length(),1));
		code = "System.out.println(“Hello World”);";
		branch.push(new Undo(code, 18, code.length(), 1));
		code = "System.out.println(“Hello World”);";
		branch.push(new Undo(code, 16, code.length(), 2));
	...
	public void delete(int pos, int count) {
		...
		branch.push(new Undo(code, 0, 2,1));
		...
		//delete(reverse.getPos(18), reverse.getCount(16));
	...
	public void pull(int version) {
		...
		String version2 = "";
		if(master.isEmpty()) {
			version2 += "Project has no committed versions";
		}
		else {
			
			for (int i = master.size(); i > 1; i--) {
				tmpStack.push(master.pop());
			}
			version2 += "\n\t" + ++tmp + ": " + master.peek();
